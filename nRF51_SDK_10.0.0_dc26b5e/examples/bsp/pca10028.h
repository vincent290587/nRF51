...
#define BUTTONS_MASK   (BSP_BUTTON_0_MASK | BSP_BUTTON_1_MASK | BSP_BUTTON_2_MASK | BSP_BUTTON_3_MASK | BSP_BUTTON_4_MASK | BSP_BUTTON_5_MASK)
...
#define SER_CONN_CHIP_RESET_PIN     29    // Pin used to reset connectivity chip
